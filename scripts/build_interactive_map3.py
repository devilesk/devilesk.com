...
def main():
    ...
    if len(sys.argv) > 1 and 'deploy' in sys.argv:
        ...
        BACKUP_ROOT = '/home/app-backups/interactivemap3'
        ...
        for f in FILES:
            shutil.copy2(ROOT + '/dota2/apps/interactivemap2/out/' + f, DEPLOY_ROOT + '/dota2/apps/interactivemap3/' + f)

    if len(sys.argv) > 1 and 'purge' in sys.argv:
        print 'Purging cloudflare cache of interactivemap2...'
        CACHE_FILES = [
            'http://devilesk.com/dota2/apps/interactivemap3/interactivemap.min.js',
            'http://devilesk.com/dota2/apps/interactivemap3/interactivemap.min.css',
            'http://devilesk.com/dota2/apps/interactivemap3/data.json',
            ]
